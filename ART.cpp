...
TGraphErrors* makeBinnedGraph(const std::vector<double>& times,
    ...
    g->SetTitle(Form("ART; Time;Counts per hour (%dh average )", hoursBin));
...
void ART() {
    ...
    std::vector<DatasetConfig> datasets = {
        {"/home/antoine/Documents/These/1-Radon/Radon_detector/3-Follow-Rn/ART/250509_083800",{ {520,580},{600, 660},{780,850} },"ART june 2025"},
        {"/home/antoine/Documents/These/1-Radon/Radon_detector/3-Follow-Rn/ART/250918_154128",{ {520,590},{600,670},{780,860} },"ART september 2025 with ARF switch on the 16th october"},
        {"/home/antoine/Documents/These/1-Radon/Radon_detector/3-Follow-Rn/ART/251103_172100",{ {520,590},{600,670},{780,850} },"ART November 2025"}
    ...
    if(!all_timestamp.empty()) {
        ...
        g2->SetTitle("ART; Time;Counts per hour");
